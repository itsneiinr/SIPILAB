...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Login Admin - SIPiLAB</title>
                ...
                <div class="login-box">
                    ...
                    <form action="{{ route('login.admin.proses') }}" method="POST">
                        ...
                        <div class="input-group">
                            <input type="email" name="username" placeholder="Email Admin">
                        </div>
                        ...
                        <div style="text-align: center; margin-top: 15px; font-size: 14px;">
                            <span style="color: #666;">Akun admin dibuat oleh administrator sistem.</span>
                        </div>
                    </form>
                </div>
            </div>
